    ...
    <section class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-3 justify-items-center">
            @forelse ($adverts as $advert)
                <article
                    ...
                    <div class="relative pb-48 overflow-hidden md:w-full">
                        <img class="absolute inset-0 h-full w-full object-cover" src="{{ asset('front_office/images/house-2.jpg') }}"
                            alt="house">
                    </div>
                    <div class="p-4">
            ...
            <article
                ...
                <div class="relative pb-48 overflow-hidden md:w-full">
                    <img class="absolute inset-0 h-full w-full object-cover"
                        src="{{ asset('front_office/images/house-3.jpeg') }}" alt="house">
                </div>
                <div class="p-4">
                    <h2 class="font-bold md:text-xl my-2 flex justify-between items-center">
                        Résidence le CARAT
                    ...
                    <div
                        class="bg-first text-gray-50 text-center text-sm py-2 hover:bg-green-500 transition-colors cursor-pointer">
                        Plus de détails
                    </div>
                </div>
            </article>
            <article
                ...
                <div class="relative pb-48 overflow-hidden md:w-full">
                    <img class="absolute inset-0 h-full w-full object-cover"
                        src="{{ asset('front_office/images/house-4.jpeg') }}" alt="house">
                </div>
                <div class="p-4">
                    <h2 class="font-bold md:text-xl my-2 flex justify-between items-center">
                        Villa John Doe
            ...
            <article
                ...
                <div class="relative pb-48 overflow-hidden md:w-full">
                    <img class="absolute inset-0 h-full w-full object-cover"
                        src="{{ asset('front_office/images/house-5.jpeg') }}" alt="house">
                </div>
                <div class="p-4">
                    <h2 class="font-bold md:text-xl my-2 flex justify-between items-center">
            ...
            <article
                ...
                <div class="relative pb-48 overflow-hidden md:w-full">
                    <img class="absolute inset-0 h-full w-full object-cover"
                        src="{{ asset('front_office/images/house-1.jpg') }}" alt="house">
                </div>
                <div class="p-4">
                    <h2 class="font-bold md:text-xl my-2 flex justify-between items-center">
                        Cité Salvator
