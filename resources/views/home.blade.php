...
@section('content')
    ...
    <main class="bg-gray-50 w-full">
        <section class="max-w-6xl mx-auto px-4">
            ...
            <a href="#" class="block shadow-md mt-3 sm:mt-5 md:mt-8 w-40 mx-auto text-sm text-center hover:text-green-500 border-green-500 border hover:bg-gray-50 transition-colors text-gray-50 bg-green-500 py-2 px-3 font-semibold">Voir Plus...</a>
        </section>
