    ...
    <header class="bg-center bg-fixed bg-no-repeat bg-cover h-screen relative">
        ...
        <div class="h-screen bg-opacity-50 bg-black flex items-center justify-center">
            <div class="mx-2 text-center">
                ...
                <form action="{{ route('adverts.index') }}" class="inline-flex sm:w-5/6 md:w-4/6 mt-4 sm:mt-6 md:mt-8 relative">
                ...
                <article
                    ...
                    <div class="p-4 relative pb-16 w-full">
                        ...
                        <div class="flex mb-2">
                            ...
                            @for ($i = 0; $i < 5; $i++)
                                @if ($rating - $i >= 1)
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-yellow-400 fill-current" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
